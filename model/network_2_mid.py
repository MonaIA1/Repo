...
'''
This code for middle fusion for RGB features
'''
...
class Feature_extractor_2D_3D(nn.Module):
    def __init__(self):
        ...
        self.rgb_feature3d = nn.Sequential(
            ...
            DownsampleBlock3d(32, 64),  #ch_out
            BottleneckDDR3d(c_in=64, c=16, c_out=64, dilation=1, residual=True),
            
            DownsampleBlock3d(64, 128),  #ch_out
            BottleneckDDR3d(c_in=128, c=32, c_out=128, dilation=1, residual=True),
    ...
    def project2D_3D(self,feature2d,depth_3d,device):
        ...
        indexo, indexi = torch.where(depth_3d > 0) #--> indexi represent pixel index (x,y coordinate) where depth value existed
